    ...
    public partial class ErrLogDefineForm : Form
    {
        ...
        public void ErrInfoMean(string errorInfo, string gErrIndex)
        {
            ...
            try
            {
                ...
                //5 Communication to Panorama LED PCBA error
                ...
                {
                    dataGridViewDownload.Rows.Add("E040101", "Communication to Panorama LED PCBA error", "In Extaro300 PEAK / Star this error should not activate");// Panorma LED error Active add by Qin Yunhe 20200330
                }

                //6 Panorama LED error
                ...
                {
                    dataGridViewDownload.Rows.Add("E040201", "Panorama LED over current/short circuit", "In Extaro300 PEAK / Star this error should not activate"); //LED over current/short circuit added by Qin yunhe 20200330
                }
                else if (panoramaLedErr.Equals("10")) //LED under current/open circuit added by Qin yunhe 20200330
                {
                    dataGridViewDownload.Rows.Add("E040202", "Panorama LED under current/open circui", "In Extaro300 PEAK / Star this error should not activate");
                }
                else if (panoramaLedErr.Equals("11")) // LED current unstable add by Qin yunhe 20200330
                {
                    dataGridViewDownload.Rows.Add("E040203", "Panorama LED current unstable", "In Extaro300 PEAK / Star this error should not activate");
                }

                //7 Communication to yoke PCBA error
                ...
                //8 OPMI Star tilt axis balancing motor error
                ...
                else if (tiltBalanceMotorErr.Equals("01")) //Motor coil open circuit add 20200330
                { 
#if false  //modified by Qin yunhe add "E020401" For record the tilt axis balancing motor error
                    dataGridViewDownload.Rows.Add("Unknown", "--", "--");
#else
                    dataGridViewDownload.Rows.Add("E020401", "OPMI Star tilt axis balancing motor open circuit",
                        "Check cable connection of the filter wheel driving motor."
                        + System.Environment.NewLine + "In Extaro300 this error should not activate .");
#endif
                }
                else if (tiltBalanceMotorErr.Equals("10")) // Motor coil short circuit add 20200330
                {
#if false   //modified by Qin yunhe add "E020402" For record the tilt axis balancing motor error
                    dataGridViewDownload.Rows.Add("Unknown", "--", "--");
#else
                    dataGridViewDownload.Rows.Add("E020402", "OPMI Star tilt axis balancing motor over current or short circuit",
                        "Check whether OPMI filter wheel structure is physically blocked."
                        + System.Environment.NewLine + "Check cable connection of the filter wheel driving motor."
                        + System.Environment.NewLine + "In Extaro300 this error should not activate.");
#endif
                }
                //modified by Qin yunhe add "E020403" For record the tilt axis balancing motor error
                else if (tiltBalanceMotorErr.Equals("11")) // Not applicable add 20200330
                {
                    dataGridViewDownload.Rows.Add("E020403", "OPMI Star tilt axis balancing motorNot applicable", "In Extaro300 this error should not activate.");
                }

                //9 OPMI Star swivel axis balancing motor error
                ...
                else if (swivelBalanceMotorErr.Equals("01")) //Motor coil open circuit 20200330
                {
#if false       //modified by Qin yunhe add "E020501" For record OPMI Star swivel axis balancing motor error
                    dataGridViewDownload.Rows.Add("Unknown", "--", "--");
#else
                    dataGridViewDownload.Rows.Add("E020501", "OPMI Star swivel axis balancing motor open circuit",
                        "Check cable connection of the filter wheel driving motor." , "In Extaro300 this error should not activate..");
                    //+ System.Environment.NewLine + "In Extaro300 this error should not activate..");
#endif
                }
                else if (swivelBalanceMotorErr.Equals("10")) //Motor coil short circuit 20200330
                {
#if false 
                    dataGridViewDownload.Rows.Add("Unknown", "--", "--");
#else            //modified by Qin yunhe add "E020502" For record OPMI Star swivel axis balancing motor error
                    dataGridViewDownload.Rows.Add("E020502", "OPMI Star swivel axis balancing motor over current or short circuit",
                        "In Extaro300 this error should not activate." 
                        //+ System.Environment.NewLine + "Check cable connection of the filter wheel driving motor."
                        //+ System.Environment.NewLine + "Replace the filter wheel driving motor and/or the filter wheel assembly if necessary."
                        );
#endif
                }
                else if (swivelBalanceMotorErr.Equals("11")) //Not applicable 20200330
                {
                    dataGridViewDownload.Rows.Add("E020503", "OPMI Star swivel axis balancing motor Not applicable", "In Extaro300 this error should not activate.");
                }
#if true        //the following sentence are add by Qin yunhe for correct the "Unknown error"20200330
                //10 Spot Illumination motor error
                string SpotIlluminationmotorerror = binaryErrLog.Substring(17,1);
                if (SpotIlluminationmotorerror.Equals("0"))
                {
                    ;
                }
                else if (SpotIlluminationmotorerror.Equals("1"))
                {
                    dataGridViewDownload.Rows.Add("E020601", "Spot Illumination motor error"
                        , "check the Apetcure motor cable ."
                         + System.Environment.NewLine + "If error persists after rectifying setting, replace the OPMI Control board."
                         ); //SpotIlluminationmotorerror activate 20200330
                }
                // the bit position 16 was reserved
#endif
