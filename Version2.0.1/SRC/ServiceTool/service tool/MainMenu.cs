        ...
        private void ButtonOpenPort_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                try
                {
                    ...
                    //check version
                     cmd = STX + CMD_SERV_VN + ETX;//"$SERV:VN$" add by Yunhe Qin 20200321
                    ...
                    ButtonClosePort.Enabled = true;
                    //the following sentence were added by Yunhe Qin to recored the License and SN and version in logfile.
                    logFiles1.LoadOperLog();
                    logFiles1.LoadErrorLog();
                    //license2.LoadActiveLicense();
                    //end 
                }
                catch
                {
...
#if true // Modified by Qin yunhe，deleted the modify ID button 
